...
class TweetService{
    ...
    async create(data){
        ...
        let tags = content.match(/#[a-zA-Z0-9_]+/g)
                        .map((tag) => tag.substring(1)) //regex to get the hashtags and to remove the # from the hashtag
                        .map(tag => tag.toLowerCase())  //to treat lower and uppercase hashtag as same
